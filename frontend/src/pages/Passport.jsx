          ...
          <div>
            ...
            <div className="card">
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                ...
                <button onClick={copy} className="btn btn-primary btn-sm hover-glow" style={{ whiteSpace: 'nowrap', background: copied ? '#3FB950' : undefined }}>
            ...
            <div className="card">
              ...
              {[
                ...
                <div key={i} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 0', borderBottom: i < 2 ? '1px solid rgba(255,255,255,0.04)' : 'none' }}>
                  ...
                  <button className="btn btn-ghost btn-sm hover-scale" onClick={s.action}>{s.btn} →</button>
                </div>
              ))}
            </div>

            <button className="btn btn-primary btn-full hover-glow" onClick={() => navigate('/jobs')} style={{ padding: 14 }}>💼 Find Jobs Now →</button>
            <button className="btn btn-ghost btn-full hover-scale" onClick={() => navigate('/evaluate')} style={{ padding: 12 }}>📤 Submit Project</button>
          </div>
        </div>
      </div>
    </div>
