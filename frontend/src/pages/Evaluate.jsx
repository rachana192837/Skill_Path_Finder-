          ...
          {!result ? (
            <>
              ...
              <div className="card" style={{ marginBottom: 16 }}>
                ...
                <button onClick={submit} disabled={loading || desc.length < 20} className={`btn btn-primary btn-full btn-lg ${loading ? 'btn-loading' : 'hover-glow'}`} style={{ marginTop: 20 }}>
                  {loading ? (
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: 12 }}>
                <button className="btn btn-primary hover-glow" onClick={() => navigate('/passport')} style={{ flex: 1, padding: 14 }}>🪪 View Skill Passport →</button>
                <button className="btn btn-ghost hover-scale" onClick={() => navigate('/jobs')} style={{ flex: 1, padding: 14 }}>💼 View Jobs</button>
              </div>
              {!result.passed && (
                <button className="btn btn-ghost btn-full hover-scale" onClick={() => setResult(null)} style={{ marginTop: 10 }}>🔄 Resubmit with More Detail</button>
              )}
            </div>
          )}
        </div>
